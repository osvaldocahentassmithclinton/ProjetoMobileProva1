  ...
  return (
    <View style={styles.container}>
      <ImageBackground style={{flex:1, width:'100%',height:'100%', padding: 40, justifyContent: 'space-between',}} source={ImagemFundo}>
        ...
        <Text style={[styles.text, styles.textCenter]}>Ja pensou como seria um jogo dark sobre algum conto de fada? Se sim, você se animará com o novo projeto "Alice in Wonderland" que estamos desenvolvendo. Se trata de um jogo de Alice no país das maravilhas em mundo que se fantasia de alegre para esconder uma verdade sombria.</Text>
        ...
        <Text style={[styles.text, styles.textCenter]}>Atual mente o Projeto ainda está em desenvolvimente, mas faça login na nossa página para receber notícias sobre o projeto da forma mais rápida!</Text>
  ...
  return (
    <View style={styles.container}>
      <ImageBackground style={{flex:1, width:'100%',height:'100%', padding: 40, justifyContent: 'space-around',}} source={ImagemFundo}>
        ...
        <Text style={[styles.title, styles.textCenter]}>ALICE IN WONDERLAND</Text>
        <Text style={[styles.atencao, styles.textCenter]}>Faça seu login abaixo!</Text>
